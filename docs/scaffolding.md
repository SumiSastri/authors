...
Dependencies:
- npm install bootstrap reactstrap uuid react-transition-group (CSS)
- npm install axios (HTTP runner)
...
FE uses modern React with Hooks and has been spun-up with create-react-app
BE uses MongoDB, Express and Node and has been spun up with babel & node
The css is Bootstrap
Code style -eslint has been set on the FE to react style guide, the back-end needs to be manually set up for rules

Code editor: VS Code

At some point test suites will be added.
